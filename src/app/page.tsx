...
export default function Dashboard() {
  ...
  const { allChartTypes, spaces, editingSpace, setEditingSpace } =
    dashnoardStore;
  ...
  return (
    <main className="main_wrapper h-[calc(100vh-95px)] grid grid-cols-6 grid-rows-3 gap-4 p-8">
      ...
      {/* 編輯模式按鈕 */}
      <div className="absolute top-6 right-10 flex flex-col items-end gap-1 z-1">
        <button
